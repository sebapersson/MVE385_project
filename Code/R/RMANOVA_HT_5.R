...
# ================================================================================================
# Filtering data for missing HT_5-values 
# ================================================================================================
specie="HT_5"
...
RMANOVA_nontransformed_HT_5 <- function(data_tidy, test_position, test_dose, short_dose, save_plot){
  ...
  dev.off()
  path_save2 <- str_c("../../Result/ez_Serotonin_", test_position,"_", short_dose, ".pdf")
  print(p3)
...
# Returns:
#   ANOVA table and plot 
RMANOVA_transformed_HT_5 <- function(data_tidy, test_position, test_dose, short_dose, save_plot){
  ...
  ggsave(filename = path_save1, plot = p2, height = 6, width = 9)
  dev.off()
  path_save2 <- str_c("../../Result/ez_Baseline_Serotonin_", test_position,"_", short_dose, ".pdf")
  print(p3)
  ggsave(filename = path_save2, plot = p3, height = 6, width = 9)
  dev.off()
...
# ================================================================================================
# Results nontransformed Serotonin (HT_5)
# ================================================================================================
